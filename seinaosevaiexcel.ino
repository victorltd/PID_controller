...
//motor
  ...
  esc.writeMicroseconds(1001); //Iniciaalizar o sinal em 1000, estará desligado o meu motor

  /*excel*/
  Serial.println("CLEARDATA");
  Serial.println("LABEL, Time, Started time, Date ,p , i, d, rpm, pwm, erro ");
  Serial.println("RESETTIMER");
   

  //delay(4000);  // We sometimes take several readings of the period to average. Since we don't have any readings
...
int throttle= 1001; //valor inicial do sinal pwm do motor
float pwmMotor;
double error=0;
//double rotacao;
double lastRotacao;
...
double setPoint=5300;  //defino o valor de rpm que eu quero
long lastProcess;
...
void loop()  // Start of loop:
{
  ...
  D= (lastRotacao - RPM) * kD * deltaTime;
  lastRotacao= RPM;
